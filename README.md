...
<br/> Платный. 50евро или 5тр

** Обновления:
2024-08-26 После рестарта, теперь сразу добавляются боссы с начальным респом (типа Ant Queen, Чудовище и прочих)
2024-08-29 Бота можно перезапустить через сайт, не нужно больше знание консоли и доступа к сервер
